---
title: "折腾 AI 工作流和 RTL 排版的一天：被 AI 坑了，也学到了"
...
顺带一提，最近感觉 Gemini 3.1 在处理多模态和复杂指令这块，确实比 Claude 要好用一点。
...
大家都在吹 AI 写代码多牛，但其实 AI 越强，越说明一件事：如果你的系统本来就耦合得很烂，代码像一坨面条，那 AI 也会被这坨面条卡死。你只有自己先把架构拆清楚、边界画明白，AI 这种 `worker` 才能真正发挥出干活快的优势。